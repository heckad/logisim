...
import com.heckad.logisim.file.LoadFailedException;
import com.heckad.logisim.file.Loader;
import com.heckad.logisim.gui.main.Print;
import com.heckad.logisim.gui.menu.LogisimMenuBar;
import com.heckad.logisim.gui.menu.WindowManagers;
import com.heckad.logisim.prefs.AppPreferences;
import com.heckad.logisim.proj.Project;
import com.heckad.logisim.proj.ProjectActions;
import com.heckad.logisim.util.LocaleManager;
import com.heckad.logisim.util.MacCompatibility;
...
import static com.heckad.logisim.util.LocaleString.getFromLocaleOptions;
...
public class Startup {
    ...
    /**
     * Parses the command-line arguments to com.cburch.logisim.LogisimMain
     *
    ...
    public static Startup parseArgs(String[] args) {
        ...
        for (String s : args) {
            if (s.equals("-tty")) {
                isTty = true;
            } else if (s.equals("-clearprefs") || s.equals("-clearprops")) {
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            if (arg.equals("-tty")) {
                ...
                //OK
                System.out.println(LogisimMain.VERSION_NAME);
                return null;
